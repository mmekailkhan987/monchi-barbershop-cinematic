...
export default function Home() {
  ...
  return (
    <>
      <div className={`loader ${loading ? "loader-visible" : "loader-hidden"}`} aria-hidden={!loading}><img src="/manus-storage/monchi-logo_eb980b29.png" alt="Monchi Barbershop" /><span>ELIZABETH · NEW JERSEY</span></div>
    <main ref={revealRef} className="site-shell">
      ...
      <header className="topbar">
        <a className="brand" href="#top" aria-label="Monchi Barbershop home"><img className="brand-logo" src="/manus-storage/monchi-logo_eb980b29.png" alt="Monchi Barbershop" /></a>
      ...
      <section id="visit" className="visit section-pad"><div className="section-kicker" data-reveal><span>04</span><span>THE VISIT</span></div><div className="visit-grid"><div data-reveal><p className="eyebrow">FIND YOUR WAY IN</p><h2>Make the<br /><i>turn.</i></h2><a className="address-link" href="https://www.google.com/maps/dir/?api=1&destination=220+Rahway+Ave%2C+Elizabeth%2C+NJ+07202" target="_blank" rel="noreferrer"><MapPin size={18} /><span>220 Rahway Ave<br />Elizabeth, NJ 07202</span><ArrowUpRight size={18} /></a><div className="contact-actions"><a className="contact-action" href="tel:+19083163431"><Phone size={16} /><span>Call</span></a><a className="contact-action" href="https://wa.me/19083163431" target="_blank" rel="noreferrer"><span className="whatsapp-glyph">W</span><span>WhatsApp</span></a><a className="contact-action" href="mailto:monchibarbershop@yahoo.com"><span className="mail-glyph">@</span><span>Email</span></a><a className="contact-action" href="https://book.heygoldie.com/Monchi-Barbershop-LLC" target="_blank" rel="noreferrer"><CalendarDays size={16} /><span>Book online</span></a></div><a className="phone-link" href="https://www.facebook.com/monchibarbershop/" target="_blank" rel="noreferrer"><span className="facebook-glyph">f</span> Facebook</a><a className="email-line" href="mailto:monchibarbershop@yahoo.com">monchibarbershop@yahoo.com</a></div><div className="hours-panel" data-reveal><div className="hours-title"><Clock3 size={17} /><span>HOURS</span><span className="open-now">OPEN TODAY</span></div>{hours.map(([day, time]) => <div className="hours-row" key={day}><span>{day}</span><span>{time}</span></div>)}</div></div></section>
      ...
      <footer className="footer"><div className="footer-brand"><img className="footer-logo" src="/manus-storage/monchi-logo_eb980b29.png" alt="Monchi Barbershop" /><p>Sharp looks. Good energy.<br />Elizabeth, New Jersey.</p></div><div className="footer-links"><a href="#story">The shop</a><a href="#services">Services</a><a href="#gallery">Gallery</a><a href="#visit">Visit</a></div><div className="footer-note">© {new Date().getFullYear()} Monchi Barbershop LLC<br /><a href="tel:+19083163431">Call</a> · <a href="https://wa.me/19083163431" target="_blank" rel="noreferrer">WhatsApp</a> · <a href="https://www.facebook.com/monchibarbershop/" target="_blank" rel="noreferrer">Facebook</a><br /><a href="mailto:monchibarbershop@yahoo.com">monchibarbershop@yahoo.com</a></div>      </footer>
    </main>
    </>);
}
